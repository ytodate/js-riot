...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__tabs__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__tabs___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__tabs__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__count__ = __webpack_require__(2);




riot.tag2('app', '<div id="main"> <div data-is="header" title="demo page"></div> <div data-is="tabs"></div> <div data-is="count" store="{opts.store}"></div> </div>', '', '', function(opts) {
...
"use strict";
/* WEBPACK VAR INJECTION */(function(riot) {Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__actions_index_js__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__actions_index_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__actions_index_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__tabs__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__tabs___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__tabs__);
...
riot.tag2('count', '<app> <div data-is="tabs"></div> <p> count: {count}</p> <button onclick="{add}">+</button> <button onclick="{minus}">-</button> </app>', '', '', function(opts) {
    this.count = 0;
    this.add = function () {
      this.count += 1;
    }.bind(this)
    ...
    this.setCount = (count) => {
      store.dispatch(__WEBPACK_IMPORTED_MODULE_0__actions_index_js___default.a.setCount(count))
    }
});
...
var SET_COUNT = exports.SET_COUNT = 'SET/COUNT';
...
/* WEBPACK VAR INJECTION */(function(riot) {riot.tag2('tabs', '<ul class="nav navbar-nav"> <li><a href="/#/count">count demo</a></li> <li><a href="/#/demo">others demo</a></li> <li><a href="/#/fruit">fruit demo</a></li> </ul>', '', '', function(opts) {
});
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var _riotRoute = __webpack_require__(14);
...
var _count = __webpack_require__(2);
...
document.addEventListener('DOMContentLoaded', function () {
  _riot2.default.mount('#app', 'app', { store: store });
});
...
(0, _riotRoute2.default)('/count', function () {
  console.log("mount count");
  _riot2.default.mount('#app', 'count', { store: store });
});

(0, _riotRoute2.default)('/fruit', function (name) {
  console.log('mount fruit');
  _riot2.default.mount('#app', 'tabs', { store: store });
});
...
/* WEBPACK VAR INJECTION */(function(riot) {riot.tag2('header', '<h1>{opts.title}</h1>', '', '', function(opts) {
});
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
